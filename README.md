...
> **برای agent‌ها و توسعه‌دهندگان**: ابتدا [`AGENTS.md`](AGENTS.md) و سپس [`docs/`](docs/) را بخوانید. این فایل، لیست اولیه‌ی امکانات و فازبندی است.
...
مدیر
	...
	سرورها
		ویرایش مشخصات سرور
        تعیین و اجرای فرآیند برای اجرا روی سرورها
            اسکریپتها زمان اجرا مشخص می‌شوند
