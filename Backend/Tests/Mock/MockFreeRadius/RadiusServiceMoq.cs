...
using PhotonBypass.Test.Mock.MockFreeRadius.Model;
...
internal class RadiusServiceMoq : Mock<IRadiusService>, IOutSourceMoq
{
    ...
    protected RadiusServiceMoq(IServiceProvider service, string file_path, string passwords_path)
    {
        ...
        Setup(x => x.SaveUserBasicInfo(It.IsNotNull<PermanentUserEntity>()))
        ...
        Setup(x => x.RegisterPermanentUser(It.IsNotNull<PermanentUserEntity>(), It.IsNotNull<string>()))
        ...
        Setup(x => x.UpdateUserDataUsage(It.IsNotNull<string>(), It.IsAny<int>()))
